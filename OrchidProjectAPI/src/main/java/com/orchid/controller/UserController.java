...
/**
 * @author Ravindra S B
 * @Controller class for User Data controller. it manages all the User
 *             Operations
 * @param
...
<<<<<<< HEAD
	// has to be fixed with some validations
	private static final String GET_USER_EMAIL = "/getUserBy";
	// it should be enhanced with some other modification
	private static final String UPDATE_USER = "/updateUser";
	// stil not working needs to be fixed
...
>>>>>>> 114317501f74e8f82b2c2a74660478e8743ed290
	...
	@ResponseBody
<<<<<<< HEAD
	public ResponseEntity<Map<String, Object>> registerController(UserDTO userDTO, HttpServletRequest request,
			HttpServletResponse response) {
		Map<String, Object> responseObject = new LinkedHashMap<String, Object>();
		if (userDTO.getEmailId() != null && userDTO.getMobileNumber() != 0 && userDTO.getPassword() != null
...
<<<<<<< HEAD
	...
	public ResponseEntity<Map<String, Object>> loginController(UserLoginDTO userLoginDTO, HttpServletRequest request,
...
>>>>>>> 114317501f74e8f82b2c2a74660478e8743ed290
		...
		if (userLoginDTO != null) {
			userDTO = userService.loginService(userLoginDTO.getEmailId(), userLoginDTO.getMobileNumber(),
	...
	@RequestMapping(value = LOGOUT_USER, headers = { "checksum=ABC123XYZ=", "Accept=application/json;charset=utf-8",
			"Content-Type=application/json" })
	public ResponseEntity<Map<String, Object>> logoutController(HttpServletRequest request,
			HttpServletResponse response) {
		Map<String, Object> responseObject = new LinkedHashMap<String, Object>();
		...
		if (session == null) {
			responseObject.put("message",
					"There is some problem in logging out from your account, Please Login again! and then Logout");
			return new ResponseEntity<Map<String, Object>>(responseObject, HttpStatus.BAD_REQUEST);
		} else {
			session.invalidate();
			session = null;
	...
	@ResponseBody
	public ResponseEntity<Map<String, Object>> getAllUsers(UserDTO userDTO, HttpServletRequest request,
			HttpServletResponse response) {
		Map<String, Object> responseObject = new LinkedHashMap<String, Object>();
...
<<<<<<< HEAD
	...
	@ResponseBody
	public ResponseEntity<Map<String, Object>> getUserByEmail(@RequestParam("emailId") String emailId,
			HttpServletRequest request, HttpServletResponse response) {
		Map<String, Object> responseObject = new LinkedHashMap<String, Object>();
	...
	public ResponseEntity<Map<String, Object>> updateUser(UserDTO userDTO, HttpServletRequest request,
			HttpServletResponse response) {

		Map<String, Object> responseObject = new LinkedHashMap<String, Object>();
		userService.updateUser(userDTO);
		responseObject.put("success", true);
		responseObject.put("message", userDTO.getFirstName() + " has been updated");
		return new ResponseEntity<Map<String, Object>>(responseObject, HttpStatus.OK);
